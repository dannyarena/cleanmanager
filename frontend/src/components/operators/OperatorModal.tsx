    ...
    <Dialog open={open} onOpenChange={(o) => { if (!o) onClose() }}>
      <DialogContent className="max-w-2xl p-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Password {isEdit ? '(lascia vuoto per non cambiare)' : '*'}</label>
          ...
          <div className="grid grid-cols-2 gap-4 items-end">
            ...
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="isManager" className="text-sm text-gray-700">Manager</label>
            </div>
          </div>
